...
const AboutDetails = () => (
    <section className='ahh'>
		<p>Grail Attorneys is a full  service law firm serving a pool of both local 
			and international clients with it’s office located in 
			the south eastern part of Nigeria; Umuahia, Abia State.
		 </p>
        <blockquote className="wp-block-quote">

		<p>At Grail Attorneys we have a team of diligent, competent and vibrant lawyers who apply their varied and combined experiences in initiative thinking to develop pragmatic and bespoke solutions to the problems of our esteemed clients.
		</p>
		</blockquote>
