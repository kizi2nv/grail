...
<details className="content-block__accordion">
  ...
  <div className="content-block__accordion-description">
    <ul>
        <li>Commonwealth of Nigeria (2015)</li>
            <li> Republic (2006)</li>
    </ul>
    </div>
</details>
<details className="content-block__accordion">
    ...
    <div className="content-block__accordion-description">
        <ul>
            <li> Association of Criminal Defense Lawyers</li>
                <li> Association of Hispanic Attorneys</li>
                    <li> Bar Association</li>
                        <li>Men's Bar Association</li>
        </ul>
    </div>
    </details>
  </div>
