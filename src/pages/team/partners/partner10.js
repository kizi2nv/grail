...
<figure className="k">
                <img className="jp" alt="CYNTHIA IFUNANYACHI" src={last}/>
				<h4> CYNTHIA IFUNANYACHI</h4>
				<p  className="senior"> Chief clerical officer</p>
				<div className="mail">
				<a className="ii" href="gmail.com">
									Email:trishcynthia@gmail.com
                                    <span itemProp="email" content="">
                                      
                                    </span>
                                 </a>
				</div>
                          <a className="ii" href="tel:(+234) 7066502943">
								  Phone No.:
	...
	<p className="details">Cynthia has a keen eye for details and the ability to prioritize tasks effectively.	</p>
