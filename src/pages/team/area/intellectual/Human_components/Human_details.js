...
const HumanDetails = () => (
    <section className='ahh'>
		<p>Our intellectual property law department is fully engaged in diverse areas of intellectual property. 
		 </p>
		...
		each client on the following areas of intellectual property:
		</p>
