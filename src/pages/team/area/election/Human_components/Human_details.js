...
const HumanDetails = () => (
    <section className='ahh'>
		<p>Election petition is sui generis.
			 ...
			 attorneys carve a niche for themselves in this unique area of law.
		 </p>
        <blockquote className="wp-block-quote">

		<p>We have a specialized team of election law experts with extensive experience in navigating the intricacies of election petition. Our understanding of the
			 time-sensitive nature of election petition and our strategic litigation approach tailored to each case is top notch..
		</p>
		</blockquote>
		...
		petition matters as a firm and also in collaboration with other law firms, which portrays our ability to be a team player.
		  ...
		  <p>
		  Our team of lawyers are specialized in resolving all legal pre and post election dispute.
		  </p>
